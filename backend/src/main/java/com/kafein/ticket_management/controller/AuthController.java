...
@Tag(name = "Auth API", description = "Kullanıcı Kimlik Doğrulama İşlemleri")
@RestController
...
public class AuthController {
    ...
    @Operation(summary = "Sisteme Giriş", 
               description = "Sistemde kayıtlı bulunan kullanıcı sisteme giriş yaparak refresh ve access token alır. Access token ile sisteme giriş yapabilir.")
    @PostMapping("/login")
    ...
    @Operation(summary = "Token Yenileme", description = "Refresh token geçerli olduğu sürece yeni access token ve refresh token oluşturulur.")
    @PostMapping("/refresh") 
