...
@Tag(name = "Ticket API", description = "Biletler için CRUD ve Filtreleme İşlemleri")
@RestController
...
public class TicketController {
    ...
    @Operation(summary = "Bilet Durumunu Güncelleme (Statü Geçişi)", 
                description = "Biletin durumu OPEN -> IN_PROGRESS -> DONE -> REOPENED sırasına uygun olarak güncellenebilir. Sadece bilete atanan kullanıcı bu işlemi yapabilir.")
    ...
    @Operation(summary = "Bilet İçeriğini Değiştirme", 
                description = "Sadece bileti oluşturan kullanıcı bilet içeriğini güncelleyebilir.")
    @PutMapping("/{id}")
